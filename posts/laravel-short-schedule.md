...
ပြီးရင် **app\\Console\\Kernel.php** မှာ **shortSchedule** ဆိုတဲ့ function တစ်ခု‌လုပ်ပြီး ကိုယ် run ချင်တဲ့ command ထည့်ပါမယ်။
...
ဆက်လက်ပြီး နောက်ကွယ်က‌နေ ဘယ်လို အလုပ်လုပ်သွားတယ်ဆိုတာ ကျွန်တော်သိလောက် share ချင်ပါတယ်။
